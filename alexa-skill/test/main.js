...
var roleArn = 'arn:aws:iam::059799941842:role/lambda_dynamo';
...
sts.assumeRole({
    ...
    if (err) { // an error occurred
        ...
        NOTE: 'firebase-auth.json' must be in the alexa-skill directory to be read properly (Local Debugging ONLY)
